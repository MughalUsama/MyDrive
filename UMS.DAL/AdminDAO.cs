...
namespace UMS.DAL
{
    public static class AdminDAO
    {
        ...
        {
            String sqlQuery = String.Format("Update dbo.Users Set Password='{0}' where Email='{1}';", newPassword, userEmail);
            try
            {
                using (DBConnection dBConnection = new DBConnection())
                {
